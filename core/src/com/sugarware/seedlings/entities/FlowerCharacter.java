...
import com.sugarware.seedlings.TouchController;
...
extends Player {
    ...
    public void update() {
        ...
        if ((Gdx.input.isKeyPressed(38) || Gdx.input.isKeyPressed(62) || touchSpace) && this.body.getLinearVelocity().y < - this.floatSpeed) {
            this.FLOAT = true;
