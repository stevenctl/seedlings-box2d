...
extends Entity {
    ...
    public void draw(SpriteBatch g) {
      ...
      g.draw(this.img, this.body.getPosition().x - this.pwidth / 2.0f, this.body.getPosition().y - this.pheight / 2.0f, this.pwidth / 2.0f, this.pheight / 2.0f, this.pwidth, this.pheight, 1.0f, 1.0f, (float)((double)(180.0f * this.body.getAngle()) / 3.141592653589793));
    ...
    @Override
    public void destroy() {
    	if(gs.getWorld()!=null)gs.getWorld().destroyBody(body);
    }
}
