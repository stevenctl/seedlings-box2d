...
implements Luminous {
    ...
    public void isColliding() {
        ...
        while (i < contactList.size) {
            ...
            if (contact.isTouching() && (contact.getFixtureA() == this.sensorFixture || contact.getFixtureB() == this.sensorFixture)) {
    ...
    public void updateLight() {
        if (this.light == null) {
            this.light = new PointLight(this.gs.rh, 100, lightCol, 3.0f, this.body.getPosition().x, this.body.getPosition().y);
